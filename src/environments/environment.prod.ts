export const environment = {
  ...
  MSAL:{
    ...
    redirectUri: 'https://red-bay-014321003.1.azurestaticapps.net', // This is your redirect URI,
    postLogoutRedirectUri: 'https://red-bay-014321003.1.azurestaticapps.net' // This is your postlogout redirect URI,
  }
};
